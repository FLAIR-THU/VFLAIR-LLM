    ...
    def attack(self):
        ...
        for attacker_ik in self.party: # attacker party #attacker_ik
            ...
            for origin_input in test_data_loader:
                ...
                print('batch_label/dummy_label:',dummy_label)
                ...
                print('sample_origin_image_list:',sample_origin_image_list[0][0][0,:5])
                dummy_image_list = copy.deepcopy(sample_origin_image_list)
                print('dummy_image_list:',dummy_image_list[0][0][0,:5])
