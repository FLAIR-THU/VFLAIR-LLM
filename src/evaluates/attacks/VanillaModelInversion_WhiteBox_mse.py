...
class VanillaModelInversion_WhiteBox_mse(Attacker):
    def __init__(self, top_vfl, args):
        super().__init__(args)
        # 
        self.attack_name = "VanillaModelInversion_WhiteBox_mse"
        self.args = args
    ...
    def attack(self):
        ...
        for attacker_ik in self.party: # attacker party #attacker_ik
            ...
            if self.args.model_architect == 'MM':
                vis_processor = self.vfl_info['vis_processors']['eval']
            ...
            for origin_input in test_data_loader:
                ...
                for _id in range(len(origin_input)):
                    ...
                    def get_cost(dummy_embedding):
                        ...
                        crit = nn.MSELoss() #nn.CrossEntropyLoss()
