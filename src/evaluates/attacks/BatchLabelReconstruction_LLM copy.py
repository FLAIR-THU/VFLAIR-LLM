...
class BatchLabelReconstruction_LLM(Attacker):
    ...
    def attack(self):
        ...
        for attacker_ik in self.party: # attacker party #attacker_ik
            ...
            # real_active_model_body_pred =  self.vfl_info['active_predict'][1]
            # print('real_active_model_body_pred:',real_active_model_body_pred.shape)
            # print(real_active_model_body_pred[0,:2,:5])
            ...
            best_rec_rate = rec_rate #recovery_rate_history[-1]  
