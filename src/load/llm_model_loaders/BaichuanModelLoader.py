...
from models.llm_models.baichuan import ModelPartitionPipelineBaichuan
...
class BaichuanModelLoader(LLMModelLoader):
    ...
    def load(self, args, model_path, is_active_party, party_idx):
        ...
        self._models=p.from_pretrained(model_path, trust_remote_code=True,**args.kwargs_model_loading)
    ...
    def load_slice(self, args, model_path, slice_index):
        ...
        model_partition_pipeline = ModelPartitionPipelineBaichuan(args=args, all_layer_num = args.all_encoders_num, 
