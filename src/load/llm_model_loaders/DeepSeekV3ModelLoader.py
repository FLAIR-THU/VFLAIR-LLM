...
from models.llm_models.deepseek import ModelPartitionPipelineDeepseekV3
from peft import LoraConfig, TaskType, get_peft_model, PeftModel, PeftModelForCausalLM


class DeepSeekV3ModelLoader(LLMModelLoader):
    ...
    def load(self, args, model_path, is_active_party, party_idx):
        ...
        p = ModelPartitionPipelineDeepseekV3(args=args, all_layer_num = all_encoders_num, 
        ...
        print('model_trainable_info.model_slice_trainable:',model_trainable_info.model_slice_trainable)
    ...
    def load_slice(self, args, model_path, slice_index):
        ...
        model_partition_pipeline = ModelPartitionPipelineDeepseekV3(args=args, all_layer_num = args.all_encoders_num, 
