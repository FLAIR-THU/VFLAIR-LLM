...
for seed in {60,61,62,63,64,65}
    do
    # python main_pipeline_llm_LIA_new.py --seed $seed --configs 3-slice/sst2_lia_wo_3

    # 1e5
    sed -i 's/"epsilon": 50/"epsilon": 1e5/g' ./configs/3-slice/sst2_lia_dp_3.json
    python main_pipeline_llm_LIA_new.py --seed $seed --configs 3-slice/sst2_lia_dp_3
