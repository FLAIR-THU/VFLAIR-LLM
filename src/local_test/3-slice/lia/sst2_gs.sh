#!/bin/bash
#SBATCH --job-name sst2_lia_gs          # 任务名叫 example
#SBATCH --gres gpu:a100:1                # 每个子任务都用一张 A100 GPU
#SBATCH --time 1-12:00:00                    # 子任务 1 天 1 小时就能跑完
#SBATCH --output exp_result/sst2_lia_gs.out
#SBATCH --mem 100000MB
...
for seed in 60 61 62 63 64 65
    ...
    python main_pipeline_llm.py --prefix "lia" --seed $seed --configs 3-slice/lia/sst2_gs
