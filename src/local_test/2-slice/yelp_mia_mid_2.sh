...
sed -i 's/"lambda": 0.5/"lambda": 0.01/g' ./configs/2-slice/yelp_mia_mid_2.json
python main_pipeline_llm_MIA.py --seed 62 --configs 2-slice/yelp_mia_mid_2
...
# 0.05
sed -i 's/"lambda": 0.00001/"lambda": 0.05/g' ./configs/2-slice/yelp_mia_mid_2.json
python main_pipeline_llm_MIA.py --seed 62 --configs 2-slice/yelp_mia_mid_2

# 0.05
sed -i 's/"lambda": 0.05/"lambda": 0.005/g' ./configs/2-slice/yelp_mia_mid_2.json
python main_pipeline_llm_MIA.py --seed 62 --configs 2-slice/yelp_mia_mid_2

sed -i 's/"lambda": 0.005/"lambda": 0.5/g' ./configs/2-slice/yelp_mia_mid_2.json
