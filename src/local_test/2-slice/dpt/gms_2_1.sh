...
# with decode  0.01 0.1
for seed in {63,64,65}
    do

    # # 0.00001
    # sed -i 's/"epsilon": 1/"epsilon": 0.00001/g' ./configs/2-slice/dpt/gms_2_1.json
    # python main_pipeline_llm_MIA_test.py --seed $seed --configs 2-slice/dpt/gms_2_1

    # # 0.0001
    # sed -i 's/"epsilon": 0.00001/"epsilon": 0.0001/g' ./configs/2-slice/dpt/gms_2_1.json
    # python main_pipeline_llm_MIA_test.py --seed $seed --configs 2-slice/dpt/gms_2_1

    # # 0.001
    # sed -i 's/"epsilon": 0.0001/"epsilon": 0.001/g' ./configs/2-slice/dpt/gms_2_1.json
    # python main_pipeline_llm_MIA_test.py --seed $seed --configs 2-slice/dpt/gms_2_1
