...
# 0.05
sed -i 's/"lambda": 0.5/"lambda": 0.05/g' ./configs/2-slice/yelp_mia_mid_3.json
python main_pipeline_llm_MIA.py --seed 61 --configs 2-slice/yelp_mia_mid_3

# 0.005
sed -i 's/"lambda": 0.05/"lambda": 0.005/g' ./configs/2-slice/yelp_mia_mid_3.json
python main_pipeline_llm_MIA.py --seed 61 --configs 2-slice/yelp_mia_mid_3

sed -i 's/"lambda": 0.005/"lambda": 0.5/g' ./configs/2-slice/yelp_mia_mid_3.json
...
for seed in {62,63,64,65}
    ...
    # 0.05
    sed -i 's/"lambda": 0.00001/"lambda": 0.05/g' ./configs/2-slice/yelp_mia_mid_3.json
    python main_pipeline_llm_MIA.py --seed $seed --configs 2-slice/yelp_mia_mid_3
