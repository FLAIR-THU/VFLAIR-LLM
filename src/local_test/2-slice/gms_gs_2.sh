...
# 100
python main_pipeline_llm_MIA.py --seed 60 --configs 2-slice/gms_mia_gs_2
...
sed -i 's/"gradient_sparse_rate": 98/"gradient_sparse_rate": 100.0/g' ./configs/2-slice/gms_mia_gs_2.json




# 99
sed -i 's/"gradient_sparse_rate": 100.0/"gradient_sparse_rate": 99/g' ./configs/2-slice/gms_mia_gs_2.json
